...
module.exports = function(resource) {
    ...
    if (resource.id) {
        ...
        resourceIdentifier.id = {attributes: resource.attributes};
        resourceIdentifier.id.relationships = _.reduce(resource.relationships, (relationships, relationData, relationName) => {
