...
describe('complex tests', function() {
    ...
    context('super nested (full linkage)', function() {
        let dataset = [
            {
        ...
        it('should include the correct related resources', function() {
            ...
            expect(types).to.have.property('books', 3);
            expect(types).to.have.property('libraries', 2);
    ...
    context('super nested (omit full linkage)', function() {
        let dataset = [
            {
                _id: '54735750e16638ba1eee59cb',
                name: 'Lone Tree Public Library',
        ...
        let error, payload;
        before(function(done) {
            serializer.serialize('libraries', dataset, {omitFullLinkage: true}, function(e, p) {
                error = e;
                payload = p;
                done(e);
            });
